...
| 模式 | 触发字段 | 适用 | 结果形态 |
|---|---|---|---|
| 求和模式 | 默认 | SAS / SDS / PHQ-9 / GAD-7 / PSS-10 / GSES / PSSS / HCL-32 / UCLA / 人际信任 | 总分 + 区间判级 + 分维度条 |
...
`node --check` 全部通过；引擎冒烟测试 20/20（含 SAS/SDS 满分/零分，PHQ-9 强制转介，PSS-10/UCLA 双向极值，FES/EMBU/EPQ/Olson/爱情三角/社交焦虑 多维均值与组合提示，人际信任双端）。
